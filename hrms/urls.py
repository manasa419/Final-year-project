...
#Department Routes
    path('dashboard/department_view/',views.Department_Detail_view.as_view(),name='dept_view'),
...
#Leave Routes
    ...
    #path('dashboard/leave/new/',views. LeaveCreateView.as_view(), name='leave_new'),
    #path('dashboard/leave/',views.LeaveListView.as_view(), name='leave_list'),
