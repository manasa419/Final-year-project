...
class Employee_Delete(LoginRequiredMixin, DeleteView):
    ...
    success_url = reverse_lazy('hrms:employee_all')  # Redirect to employee list or another appropriate page
    login_url = 'hrms:login'
...
class Department_Detail_view (LoginRequiredMixin,CreateView, ListView):
    model = Department
    template_name = 'DLview.html'
    form_class = DepartmentForm
    login_url = 'hrms:login'
    success_url = reverse_lazy('hrms:dept_view')
